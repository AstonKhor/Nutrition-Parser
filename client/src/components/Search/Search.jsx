...
let Search = ({ nutrients, params, addParam, clearParams, handleSearch, currentFoods, removeParam }) => {
  //reset the values in 
  return (
      <Style.Search>
        ...
        <Style.SecondRowContainer>
          <CurrentFoods currentFoods={currentFoods} handleSearch={handleSearch}/>
